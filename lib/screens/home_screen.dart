import 'package:designcode/components/home_screen_nav_bar.dart';
...
class _HomeScreen extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    sidebarAnimation = Tween<Offset>(
      begin: Offset(-1, 0),
        ...
        parent: sidebarAnimationCoontroller, curve: Curves.easeInOut));
  ...
  void dispose() {
    super.dispose();
    sidebarAnimationCoontroller.dispose();
  }
                  ...
                  FadeTransition(
                    ...
                    child: GestureDetector(
                      ...
                      onTap: () {
                        ...
                        sidebarAnimationCoontroller.reverse();
                      },
                    ),
                  ),
                  SlideTransition(
