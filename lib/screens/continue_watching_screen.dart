...
class ContinueWatchingScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SlidingUpPanel(
      ...
      boxShadow: [BoxShadow(color: kShadowColor, offset: Offset(0, -12), blurRadius: 32.0)],
      minHeight: 85.0,
          ...
          Center(
            child: Padding(
              ...
              child: Container(
                width: 42.0,
                height: 4.0,
                decoration: BoxDecoration(color: Color(0xFFC5CBD6), borderRadius: BorderRadius.circular(2.0)),
              ),
            ),
          ),
          Padding(
