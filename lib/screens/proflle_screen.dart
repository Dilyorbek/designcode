...
import 'package:designcode/components/cards/completed_course_card.dart';
import 'package:designcode/components/certificate_viewer.dart';
import 'package:designcode/components/lists/completed_course_list.dart';
                    ...
                    Container(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return Container(
                            padding: EdgeInsets.only(left: 20.0, right: index != (badges.length - 1) ? 0.0 : 20.0),
                            decoration: BoxDecoration(
                              boxShadow: [
                                BoxShadow(
